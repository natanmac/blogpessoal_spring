...
1. Clone o repositório do Projeto [Blog Pessoal](https://github.com/natanmac/blogpessoal_spring) dentro da pasta do *Workspace* do STS

```bash
git clone https://github.com/natanmac/blogpessoal_spring.git
```
