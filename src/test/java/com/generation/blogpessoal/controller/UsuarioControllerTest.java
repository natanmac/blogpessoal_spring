...
public class UsuarioControllerTest {
	...
	public void deveCadastrarUsuario() {
		...
		ResponseEntity<Usuario> resposta = testRestTemplate.exchange(BASE_URL_USUARIO + "/cadastrar", HttpMethod.POST, requisicao, Usuario.class);
	...
	@Test
	@DisplayName("Não permitir duplicação do usario")
	...
	@Test
	@DisplayName("Deve listar todos Usuario com sucesso")
	public void deveListarTodosUsuarios() {
		...
		ResponseEntity<Usuario[]> resposta = testRestTemplate
				.withBasicAuth(USUARIO_ROOT_EMAIL, USUARIO_ROOT_SENHA)
				.exchange(BASE_URL_USUARIO + "/all", HttpMethod.GET, null, Usuario[].class);
